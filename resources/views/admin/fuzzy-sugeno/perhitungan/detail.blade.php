        ...
        <div class="card mb-4 border-0 shadow-sm no-print">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    @else
                        <a href="{{ route('admin.ranking.index') }}" class="btn btn-outline-secondary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center bg-light">
                                ...
                                {{-- Jenis + sumber data --}}
                                <div class="mb-2">
                                    {{-- FIX: Menggunakan isset untuk mengecek 'jenis' karena array mapping sedikit berubah --}}
                                    @if(isset($k['jenis']) && $k['jenis'] === 'kontinu')
                                ...
                                <div class="px-2 py-2 rounded bg-white border small">
                                    ...
                                    {{-- FIX: Menggunakan 'input' secara langsung (karena kita sudah mengatur fallback '0' di Service) --}}
                                    @if($k['input'] === '0' || $k['input'] === 0 || $k['input'] === '')
                                        <span class="fw-bold text-danger fs-6" title="Data kosong/tidak diisi">0 (Tidak Terisi)</span>
                                    @else
