    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mb-1">
                        <li class="breadcrumb-item"><a href="{{ route('uptd.cpcl.index') }}">Data CPCL</a></li>
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('uptd.cpcl.index') }}" class="btn btn-label-secondary shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-5">
                <div class="card mb-4 border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        @php
                            $status = strtolower($cpcl->status ?? 'baru');
                            $statusConfig = [
                                'baru' => ['class' => 'bg-label-info', 'label' => 'Data Baru'],
                                'terverifikasi' => ['class' => 'bg-label-success', 'label' => 'Terverifikasi'],
            ...
            {{-- RIGHT COLUMN: TECHNICAL DETAIL & NOTES --}}
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-dark small lh-base">
                                    {{ $cpcl->catatan_verifikator ?? 'Belum ada catatan atau instruksi dari verifikator.' }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-footer bg-white shadow-sm justify-content-between">
                <div class="btn-group shadow-sm" id="imgControls">
                    <button type="button" class="btn btn-white text-dark" onclick="zoomOut()"><i class="bx bx-minus"></i></button>
                    <button type="button" class="btn btn-white text-dark border-start border-end" onclick="resetTransform()"><i class="bx bx-refresh"></i></button>
                    <button type="button" class="btn btn-white text-dark" onclick="zoomIn()"><i class="bx bx-plus"></i></button>
                    <button type="button" class="btn btn-white text-dark border-start" onclick="rotate()"><i class="bx bx-rotate-right"></i></button>
                </div>
...
<script>
    ...
    function previewFile(url, title) {
        ...
        if (ext === 'pdf') {
            ...
            viewer.innerHTML = `<img id="imgViewer" src="${url}" class="img-fluid" style="transition: transform 0.3s ease; transform-origin: center center;">`;
        }
